...
/**
 * Resource bundle containing messages.<br>
 * <b>Example</b><br>
 * Resources in message format:
 *
 * <pre>
 * color.green=green
...
public final class MessageBundle {
   ...
   * Translate message.
   */
  public static String translate(final ResourceBundle bundle, final Message message) {
    // unpack message
    final String key = message.getKey();
    final Map<String, String> arguments = message.getArguments();
    // start translating
    String intermediate = bundle.getString(key);
    // lookup arguments
    ...
    for (final String indirectionKey : indirectionKeys) {
      ...
      final String argumentValue = bundle.getString(indirectionValue);
   ...
   */
  public MessageBundle(final ResourceBundle bundle) {
    this.bundle = bundle;
  }
  ...
  public String translate(final Message message) {
    return translate(bundle, message);
  }
}
